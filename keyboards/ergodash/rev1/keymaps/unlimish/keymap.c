...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |IMEOFF|                    |IMEON |   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LGUI,           LOWER,   KC_TAB ,KC_BSPC,         KC_ENT,KC_SPC , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_UNDS,                        KC_PLUS, KC_CIRC, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_PIPE, \
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_H,    KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_DQT , \
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_WH_D, KC_WH_U, KC_TRANS, KC_RSFT, \
  ...
  switch (keycode) {
    ...
    case LOWER:
      if (record->event.pressed) {
        ...
        if (lower_pressed) {
          register_code(KC_IMEOFF);
          unregister_code(KC_IMEOFF);
        }
        lower_pressed = false;
      }
      return false;
    ...
    case RAISE:
      if (record->event.pressed) {
        ...
        if (raise_pressed) {
          register_code(KC_IMEON);
          unregister_code(KC_IMEON);
        }
        raise_pressed = false;
      }
      return false;
